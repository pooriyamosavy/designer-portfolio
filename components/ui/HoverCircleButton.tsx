...
export default function HoverCircleButton({ title }: Props) {
  return (
    <button className="group relative overflow-hidden rounded-full bg-[#FAA381] px-[26px] py-[10px] text-lg transition-all w-full">
      ...
      <span className="font-semibold text-black text-[20px]">{title}</span>
    </button>
  );
}
